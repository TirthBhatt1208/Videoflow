...
export const getStatusBadge = (status: string) => {
  const styles: Record<string, string> = {
    ...
    METADATA_EXTRACTED: "bg-indigo-100 text-indigo-700 border-indigo-200",
    VTT_GENERATED: "bg-purple-100 text-purple-700 border-purple-200",
    VTTGENERATED: "bg-purple-100 text-purple-700 border-purple-200",
    TRANSCODED: "bg-orange-100 text-orange-700 border-orange-200",
    HLS_READY: "bg-teal-100 text-teal-700 border-teal-200",
    COMPLETED: "bg-green-100 text-green-700 border-green-200",
    FAILED: "bg-red-100 text-red-700 border-red-200",
    // Legacy lowercase values (keeping backward compatibility)
...
export const menuItems = [
  ...
  { id: "allVideos", icon: Film, label: "All Videos" },
